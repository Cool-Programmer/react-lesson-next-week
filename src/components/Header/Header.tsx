...
function Header({handleOpen, handleClose, open, headerRef} : any) {

  const contextVal : any = useContext(AppContext);
        ...
        <div className="container" ref={headerRef}>
            <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                <NavLink to="/" className="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
                    <img src={contextVal.logoCDNUrl} width="120px" alt="Logo" />
                </NavLink>

                <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    {
                        Object.entries(contextVal.menuItems).map(([label, path], index)=>(
                            <li key={index}>
